...
module.exports = {
	...
	other: function(text,key,callback){
		request(`https://translate.google.com/translate_tts?ie=UTF-8&q=${encodeURIComponent(text)}&tl=${key}&client=tw-ob`).pipe(fs.createWriteStream(__dirname+'/../src/say.mp3')).on('close',() => callback())
	}
}
